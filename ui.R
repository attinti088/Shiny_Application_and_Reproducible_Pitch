...
shinyUI(fluidPage(
    ...
    # Application title
    titlePanel("To Pridict the price for Diamonds"),
    
    # Sidebar with options selectors
    sidebarLayout(
        sidebarPanel(
            helpText("This app is to pridict the price of a diamond based on its characteristics."),
            h3(helpText("Select:")),
            ...
            selectInput("clar", label = h4("Clarity"),
                        choices = list("All" = "*", "I1" = "I1", "SI2" = "SI2",
